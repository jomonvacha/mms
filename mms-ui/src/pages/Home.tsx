    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card p-6 space-y-2">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100">Authentication &amp; 2FA</h3>
        ...
        <div className="card p-6 space-y-2">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100">Roles &amp; Features</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="card p-6 space-y-2">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100">Enterprise Standard</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
