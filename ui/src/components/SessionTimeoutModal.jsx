                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={confirmSignout}>Sign Out Now
                            </button>
                            <button type="button" className="btn btn-primary" onClick={extendSession}>Stay Signed In
                            </button>
                        </div>
                    </div>
                </div>
